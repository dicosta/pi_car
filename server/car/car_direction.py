#!/usr/bin/env python
import car.PCA9685 as servo
import time                # Import necessary modules
import math

def Map(x, in_min, in_max, out_min, out_max):
	return (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min #needs fix
...
def set_angle(angle):
	global leftPWM
	global rightPWM
	interpolated_angle = math.floor(((angle - -45) * (rightPWM - leftPWM)/(45 - -45)) + leftPWM)
	pwm.write(0, 0, interpolated_angle)
